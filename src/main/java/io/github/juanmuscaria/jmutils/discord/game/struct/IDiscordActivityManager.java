...
public class IDiscordActivityManager extends Structure {
    ...
    public IDiscordActivityManager(register_command_callback register_command, register_steam_callback register_steam, update_activity_callback update_activity, clear_activity_callback clear_activity, send_request_reply_callback send_request_reply, send_invite_callback send_invite, accept_invite_callback accept_invite) {
        super();
    ...
    public interface update_activity_callback extends Callback {
        void apply(IDiscordActivityManager manager, DiscordActivity activity, Pointer callback_data, update_activity_callback_callback_callback callback);
    }
    ...
    public interface clear_activity_callback extends Callback {
        void apply(IDiscordActivityManager manager, Pointer callback_data, clear_activity_callback_callback_callback callback);
    }
    ...
    public interface send_request_reply_callback extends Callback {
        void apply(IDiscordActivityManager manager, long user_id, int reply, Pointer callback_data, send_request_reply_callback_callback_callback callback);
    }
    ...
    public interface send_invite_callback extends Callback {
        void apply(IDiscordActivityManager manager, long user_id, int type, Pointer content, Pointer callback_data, send_invite_callback_callback_callback callback);
    }
    ...
    public interface accept_invite_callback extends Callback {
        void apply(IDiscordActivityManager manager, long user_id, Pointer callback_data, accept_invite_callback_callback_callback callback);
    }
