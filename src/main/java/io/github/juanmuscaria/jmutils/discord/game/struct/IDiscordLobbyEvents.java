...
public class IDiscordLobbyEvents extends Structure {
    ...
    public IDiscordLobbyEvents(on_lobby_update_callback on_lobby_update, on_lobby_delete_callback on_lobby_delete, on_member_connect_callback on_member_connect, on_member_update_callback on_member_update, on_member_disconnect_callback on_member_disconnect, on_lobby_message_callback on_lobby_message, on_speaking_callback on_speaking, on_network_message_callback on_network_message) {
        super();
